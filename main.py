...
class PlayWidgets:
    def __init__(self):
        ...
        self.tool_crafter_selector = ComboBox(win.renderer, "sword", ["katana", "sword", "maru", "kobuse"], unavailable_tool_names, command=self.tool_crafter_selector_command, text_color=WHITE, bg_color=pygame.Color("aquamarine4"), extension_offset=(-1, 0), visible_when=lambda: g.midblit == "tool-crafter", font=orbit_fonts[15])
